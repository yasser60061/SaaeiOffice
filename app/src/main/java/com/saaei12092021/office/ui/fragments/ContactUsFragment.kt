...
class ContactUsFragment : Fragment() {
    ...
    // we used the same ui in faq fragment to view web view only at this time
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as HomeActivity).binding.homeTitleTv.text = "تواصل معنا"
        val  webUrl = Constant.WEB_VIW_URL +"contact-us?view=mobile"
