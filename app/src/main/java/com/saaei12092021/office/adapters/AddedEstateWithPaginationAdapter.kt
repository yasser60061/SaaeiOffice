...
class AddedEstateWithPaginationAdapter(private val listener: OnClickListener) : RecyclerView.Adapter<AddedEstateWithPaginationAdapter.ArticleViewHolder>() {

    lateinit var mContext: Context

    inner class ArticleViewHolder(private val binding: AddedEstateItemBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(requestedEstateAdded: Data) {
            binding.apply {
                try {
               ...
               val propertyAdapter = PropertiesForAdsWithPaginationAdapter()
                propertyRv.apply {
